    ...
    pub(crate) fn update_egui(&mut self, window: &winit::window::Window) {
        ...
        egui::SidePanel::right("控制面板")
            ...
            .show(&self.egui_ctx, |ui| {
                ...
                ui.add_space(4.0);
                ui.horizontal(|ui| {
                    ui.checkbox(&mut show_background, "背景");
                    ui.checkbox(&mut show_bodies, "天体");
                });
                ui.horizontal(|ui| {
                    ui.checkbox(&mut show_waves, "引力波");
                    ui.checkbox(&mut show_trails, "轨迹预测");
                });
